...
// Linear time O(n)
// The function runs ${num} amount of times.
...
// Linear time O(n)
// The function runs ${arr.length} amount of times.
...
// Linear time O(n)
// The function runs ${str.length} amount of times.
...
// Linear time O(n)
// The function runs ${n} amount of times.
...
// Linear time O(n)
// The function runs as many times as there is a seperator inside the ${str}.
...
// The input is divided by 2 in every cycle making the size of the input grow the run time by a factor of 1/2.
...
// Polynomial O(n^2)
// Nested loops => There are ${str.length} nested loops within the initial for loop.
...
// Linear O(n)
// The function will run for the number of ${parent} matches in the object array.
...
// Polynomial O(n^2)
// Nested loops => function runs a loop for every level of the data object.
