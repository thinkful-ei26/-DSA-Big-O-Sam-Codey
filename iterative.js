...
// Linear O(n)
// runs while str contains a seperator.
...
// Logarithmic O(log(n))
// the input is divided by 2 in every while loop until it reaches 0.
...
// Linear O(n)
// the number of loops in the while loop is directly related to the input.
